import 'package:app_eyeforyou/care9_nosev.dart';
import 'package:app_eyeforyou/care9_sev.dart';
import 'package:app_eyeforyou/explain_benefit_second.dart';
import 'package:flutter/material.dart';

class BenefitCare9 extends StatelessWidget{
  const BenefitCare9({Key? key}) : super(key: key);
              ...
              children: <Widget>[
                OptionCard(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Care9Sev()),
                    );
                  },
                ),
                SizedBox(width: 30),
                OptionCard(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Care9NoSev()),
                    );
                  },
                ),
              ],
