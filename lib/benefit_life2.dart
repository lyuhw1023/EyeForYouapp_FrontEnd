...
import 'package:app_eyeforyou/life2_nosev.dart';
import 'package:app_eyeforyou/life2_sev.dart';
import 'package:flutter/material.dart';

class BenefitLife2 extends StatelessWidget{
  const BenefitLife2({Key? key}) : super(key: key);
              ...
              children: <Widget>[
                OptionCard(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Life2Sev()),
                    );
                  },
                ),
                SizedBox(width: 30),
                OptionCard(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Life2NoSev()),
                    );
                  },
                ),
              ],
