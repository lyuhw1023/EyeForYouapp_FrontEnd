...
import 'package:app_eyeforyou/explain_care6_nosev.dart';
import 'package:flutter/material.dart';

class Care6NoSev extends StatelessWidget{
        ...
        actions: [
          IconButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => ExplainCare6Nosev()),
              );
            },
