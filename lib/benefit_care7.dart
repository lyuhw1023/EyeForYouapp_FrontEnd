import 'package:app_eyeforyou/care7_nosev.dart';
import 'package:app_eyeforyou/care7_sev.dart';
import 'package:app_eyeforyou/explain_benefit_second.dart';
import 'package:flutter/material.dart';

class BenefitCare7 extends StatelessWidget{
  const BenefitCare7({Key? key}) : super(key: key);
              ...
              children: <Widget>[
                OptionCard(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Care7Sev()),
                    );
                  },
                ),
                SizedBox(width: 30),
                OptionCard(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Care7NoSev()),
                    );
                  },
                ),
              ],
