import 'package:app_eyeforyou/care10_nosev.dart';
import 'package:app_eyeforyou/care10_sev.dart';
import 'package:app_eyeforyou/explain_benefit_second.dart';
import 'package:flutter/material.dart';

class BenefitCare10 extends StatelessWidget{
  const BenefitCare10({Key? key}) : super(key: key);
              ...
              children: <Widget>[
                OptionCard(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Care10Sev()),
                    );
                  },
                ),
                SizedBox(width: 30),
                OptionCard(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Care10NoSev()),
                    );
                  },
                ),
              ],
