import 'package:app_eyeforyou/care6_nosev.dart';
import 'package:app_eyeforyou/care6_sev.dart';
import 'package:app_eyeforyou/explain_benefit_second.dart';
import 'package:flutter/material.dart';

class BenefitCare6 extends StatelessWidget{
  const BenefitCare6({Key? key}) : super(key: key);
              ...
              children: <Widget>[
                OptionCard(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Care6Sev()),
                    );
                  },
                ),
                SizedBox(width: 30),
                OptionCard(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Care6NoSev()),
                    );
                  },
                ),
              ],
