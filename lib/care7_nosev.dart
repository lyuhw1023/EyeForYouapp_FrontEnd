...
import 'package:app_eyeforyou/explain_care7_nosev.dart';
import 'package:flutter/material.dart';

class Care7NoSev extends StatelessWidget{
        ...
        actions: [
          IconButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => ExplainCare7Nosev()),
              );
            },
