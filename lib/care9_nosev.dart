...
import 'package:app_eyeforyou/explain_care9_nosev.dart';
import 'package:flutter/material.dart';

class Care9NoSev extends StatelessWidget{
        ...
        actions: [
          IconButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => ExplainCare9Nosev()),
              );
            },
